        ...
        >
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mr-auto">
              ...
              <li className="nav-item">
                <a className="nav-link" href="malls.html">
                  Malls
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="schools.html">
                  Schools
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="top10.html">
                  Top 10
                </a>
              </li>
            </ul>
          ...
          <div className="container">
            ...
            <div className="input-group">
              ...
              <span className="input-group-btn">
                <button
                  className="btn btn-secondary btn-lg src-button"
                  type="submit"
                >
                  {" "}
                  Search{" "}
