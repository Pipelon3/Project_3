        ...
        <div className="jumbotron jumbotron-fluid">
          <div className="container">
            ...
            <div className="card-deck">
              <div className="card">
                <img src="./assets/images/u-u_campus.jpg" className="card-img-top" alt="Fashion" />
              ...
              <div className="card">
                <img src="./assets/images/u-u_sandycampus.jpg" className="card-img-top" alt="South" />
                <div className="card-body">
              ...
              <div className="card">
                <img src="./assets/images/byu.jpg" className="card-img-top" alt="city" />
                <div className="card-body">
                  <h5 className="card-title">BYU</h5>
                </div>
                <ul className="list-group list-group-flush">
                  <li className="list-group-item">Location:Provo</li>
                  <li className="list-group-item">Number of Bathroom: 3</li>
                  <li className="list-group-item">Overall Rating</li>
                  <div className="star-rating">
                    <input type="radio" id="5-stars" name="rating" defaultValue={5} />
